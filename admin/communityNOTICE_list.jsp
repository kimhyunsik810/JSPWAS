...
<body>
	<div align="center">
		...
		[<a href="community_write.jsp?pageType=<%= "NOTICE" %>">게시글 작성</a>]
		<HR>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						<table id="mytable" class="table table-bordred table-striped">
							...
							<tr>
								...
								<td><%= c.getCmtType() %> </td>
								<td>
									<a href="community_view.jsp?pageType=NOTICE-<%=c.getCmtId()%>">
										<%= c.getCmtTitle() %>
									</a>
								</td>
								<td><%= c.getCmtUser() %> </td>
								...
								<td><p data-placement="top" data-toggle="tooltip" title="Edit">
										<a href="communityNOTICE_control.jsp?action=edit&cmtId=<%= c.getCmtId() %>">
								...
								<td><p data-placement="top" data-toggle="tooltip" title="Delete">
										<a href="communityNOTICE_control.jsp?action=delete&cmtId=<%= c.getCmtId() %>">
