...
<body>
	<div align="center">
		<H2>게시글 수정</H2>
		[<a href=communityEVENT_control.jsp?action=list>게시글 목록으로</a>]
		<hr>
		<p>
		<form name=form1 method=post action=communityEVENT_control.jsp>
				...
				<tbody>
					<tr>
						...
						<select class="form-control" name="cmtType">
							<option value="이벤트" <% if(cmt.getCmtType().equals("이벤트")) { %> selected <% } %> >이벤트</option>
						</select>
						</td>
