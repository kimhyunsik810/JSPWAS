...
<body>
	<div align="center">
		<H2>게시글 수정</H2>
		[<a href=communityNOTICE_control.jsp?action=list>게시글 목록으로</a>]
		<hr>
		<p>
		<form name=form1 method=post action=communityNOTICE_control.jsp>
				...
				<tbody>
					<tr>
						...
						<select class="form-control" name="cmtType">
							<option value="공지사항" <% if(cmt.getCmtType().equals("공지사항")) { %> selected <% } %> >공지사항</option>
						</select>
						</td>
