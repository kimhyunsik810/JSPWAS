...
<% 
	...
	ArrayList<Product> products = productManager.searchProducts(query);
%>

<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h2 class="productTitle">검색 결과</h2>
			<% if (products.isEmpty()) { %>
			<div class="text-center">결과가 없습니다!</div>
			<% } else { %>
			<table class="table">
			<% 
				for (Product p : (ArrayList<Product>) products) { 
					String status = p.getStatus().equals("중고") ? " (중고)" : "";
			%>
				<tr>
						...
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">
									<a href="index.jsp?CONTENTPAGE=content_detail.jsp?no=<%= p.getNo() %>"><%= p.getName() + status %></a>
								</h4>
