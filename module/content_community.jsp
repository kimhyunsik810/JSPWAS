...
<div class="container">
	<div class="row">
		...
		<table class="table table-striped" style="text-align: center: border: 1px solid #DDDDDD;">
			...
			<tbody>
				<%
					...
					ArrayList<Community> list = cmtMng.getList(pageNumber, "ALL");
				...
				<tr>
					...
					<td>
						...
						%>
						<a href="index.jsp?CONTENTPAGE=content_community_view.jsp?pageType=<%= "ALL" %>-<%= list.get(i).getCmtId() %>">
		...
		<%
			if(1 < pageNumber) {
		%>
		<a class="btn btn-success btn-arraw-left" href="index.jsp?CONTENTPAGE=content_community.jsp?pageNumber=<%= pageNumber - 1 %>">이전</a>
		<%
			}
			
			if(cmtMng.nextPage((pageNumber + 1), "ALL")) {
		%>
		<a class="btn btn-success btn-arraw-left" href="index.jsp?CONTENTPAGE=content_community.jsp?pageNumber=<%= pageNumber + 1 %>" >다음</a>
		<%
			}
		...
		<a class="btn btn-primary pull-right" href="index.jsp?CONTENTPAGE=content_community_write.jsp">게시글 작성</a>	
